...
public abstract class AbstractBindableListModelNew<Key, Value> extends
		BindableListModelNew<Key, Value> {
	protected List<Value> records;

	public AbstractBindableListModelNew() {
	...
	public abstract List<Value> getValues(String str, Key key);
