...
/**
 * A layout manager that accepts a delegate layout manager for actual layout, in
 * addition to a "glass pane" component that is layed out above all other
...
public class GlassLayout extends Object implements LayoutManager2, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8014374914124803449L;
	...
	public GlassLayout(Container container, LayoutManager delegate) {
		...
		if (container == null) {
			throw new IllegalArgumentException(
					"Parameter \"container\" cannot be null"); // NOI18N
		}

		if (delegate == null) {
			throw new IllegalArgumentException(
					"Parameter \"delegate\" cannot be null"); // NOI18N
		}
	...
	public void addLayoutComponent(Component comp, Object constraints) {
		if (GLASS.equals(constraints) && comp instanceof JComponent) {
			...
			((LayoutManager2) getDelegate()).addLayoutComponent(comp,
					constraints);
		}
	}
