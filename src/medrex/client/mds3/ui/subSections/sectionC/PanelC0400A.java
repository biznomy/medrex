...
public class PanelC0400A extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3194121132014333047L;
	Theme theme = new BlackOverWhiteTheme();
	private JxComboBox cmbAbleToRecallSock;
	...
	public PanelC0400A() {
		...
		cmbAbleToRecallSock = new JxComboBox();
		cmbAbleToRecallSock.setTheme(theme);
		cmbAbleToRecallSock.setBounds(17, 31, 50, 20);
		cmbAbleToRecallSock.setModel(new DefaultComboBoxModel(new String[] {
				"", "0", "1", "2" }));

		cmbAbleToRecallSock.setPreferredSize(new Dimension(50, 20));
		panel_1.add(cmbAbleToRecallSock);
		...
		panel_2.add(aNationalProviderLabel_3_1_1_2);
	...
	public void doSave() {
		...
		Object obj = cmbAbleToRecallSock.getSelectedItem();
		if (obj != null) {
			sectionC
					.setC0400A(cmbAbleToRecallSock.getSelectedItem().toString());
		} else {
			sectionC.setC0400A("");
		}
	}
	...
	public void doUpdate() {
		Mds3SectionC mds3sectionC = (Mds3SectionC) Mds3Controller.getInstance()
				.getSection(Mds3SectionC.class);
		cmbAbleToRecallSock.setSelectedItem(mds3sectionC.getC0400A());
	}
