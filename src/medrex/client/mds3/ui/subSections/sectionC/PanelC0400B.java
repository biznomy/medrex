...
public class PanelC0400B extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4975438994647852464L;
	Theme theme = new BlackOverWhiteTheme();
	private JxComboBox cmbAbleToRecallBlue;
	...
	public PanelC0400B() {
		...
		cmbAbleToRecallBlue = new JxComboBox();
		cmbAbleToRecallBlue.setTheme(theme);
		cmbAbleToRecallBlue.setBounds(17, 31, 50, 20);
		cmbAbleToRecallBlue.setModel(new DefaultComboBoxModel(new String[] {
				"", "0", "1", "2" }));

		cmbAbleToRecallBlue.setPreferredSize(new Dimension(50, 20));
		panel_1.add(cmbAbleToRecallBlue);
	...
	public void doSave() {
		...
		Object obj = cmbAbleToRecallBlue.getSelectedItem();
		if (obj != null) {
			sectionC
					.setC0400B(cmbAbleToRecallBlue.getSelectedItem().toString());
		} else {
			sectionC.setC0400B("");
		}
	...
	public void doUpdate() {
		Mds3SectionC mds3sectionC = (Mds3SectionC) Mds3Controller.getInstance()
				.getSection(Mds3SectionC.class);
		cmbAbleToRecallBlue.setSelectedItem(mds3sectionC.getC0400B());
	}
