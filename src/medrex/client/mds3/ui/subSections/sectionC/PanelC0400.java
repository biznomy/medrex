...
public class PanelC0400 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 807822705747382703L;
	...
	public PanelC0400() {
		...
		panel.setPreferredSize(new Dimension(840, 25));
		...
		a0100Label_1_1_2.setBounds(0, 0, 500, 25);

		a0100Label_1_1_2.setFontSize(12);
		a0100Label_1_1_2.setText("<html><body><b>C0400. Recall");
