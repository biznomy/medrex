...
public class PanelD0350 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 368065400595778871L;
	Theme theme = new BlackOverWhiteTheme();
	private JxComboBox cmbD0350;
	...
	public PanelD0350() {
		...
		a0100Label_2
				.setText("<html><body> <b> D0350. Safety Notification - </b> Complete only if D020011 = 1 indicating possibility of resident self harm");
		...
		cmbD0350 = new JxComboBox();
		cmbD0350.setTheme(theme);

		cmbD0350.setBounds(10, 20, 50, 22);
		cmbD0350.setModel(new DefaultComboBoxModel(
				new String[] { "", "0", "1" }));
		panel_6_3.add(cmbD0350);
	...
	public void doSave() {
		...
		Object obj = cmbD0350.getSelectedItem();
		if (obj != null) {
			mds3sectionD.setD0350((String) cmbD0350.getSelectedItem());
		} else {
			mds3sectionD.setD0350("");
		}
	}
	...
	public void doUpdate() {
		Mds3SectionD mds3sectionD = (Mds3SectionD) Mds3Controller.getInstance()
				.getSection(Mds3SectionD.class);
		cmbD0350.setSelectedItem(mds3sectionD.getD0350());
	}
