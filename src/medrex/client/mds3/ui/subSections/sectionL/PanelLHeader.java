...
public class PanelLHeader extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5262435513656232330L;
	...
	public PanelLHeader() {
		...
		sectionALabel.setText("Section L");
		...
		identificationInformationLabel.setText("Oral/Dental Status");
