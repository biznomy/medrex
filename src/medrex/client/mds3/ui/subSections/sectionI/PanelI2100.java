...
public class PanelI2100 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3361853719098997590L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb2100;
	...
	public PanelI2100() {
		...
		cb2100 = new JxCheckBox();
		cb2100.setTheme(theme);

		cb2100.setBounds(30, 2, 16, 16);
		panel_1.add(cb2100);
		cb2100.setText(" ");
		...
		label.setText("<html><b>12100. Septicemia");
	...
	public void doSave() {
		...
		mds3sectionI.setI2100(cb2100.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb2100.setSelected(mds3sectionI.isI2100());
	}
