...
public class PanelPsychiatricMoodDisorder extends JxPanel implements
		Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4932012186275429431L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelPsychiatricMoodDisorder() {
		super();
		...
		label.setText(" Psychiatric mood Disorder");
