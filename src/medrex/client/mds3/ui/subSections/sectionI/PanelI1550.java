...
public class PanelI1550 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6351776560863775786L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1550;
	...
	public PanelI1550() {
		...
		cb1550 = new JxCheckBox();
		cb1550.setTheme(theme);

		cb1550.setBounds(30, 2, 16, 16);
		panel_1.add(cb1550);
		cb1550.setText(" ");
		...
		label.setText("<html><b>11550. Neurogenic Bladder");
	...
	public void doSave() {
		...
		mds3sectionI.setI1550(cb1550.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1550.setSelected(mds3sectionI.isI1550());
	}
}
