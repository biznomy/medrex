...
public class PanelI4000 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2717890454447177946L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb4000;
	...
	public PanelI4000() {
		...
		cb4000 = new JxCheckBox();
		cb4000.setTheme(theme);

		cb4000.setBounds(30, 2, 16, 16);
		panel_1.add(cb4000);
		cb4000.setText(" ");
		...
		label.setText("<html><b>14000.  Other Fractures");
	...
	public void doSave() {
		...
		mds3sectionI.setI4000(cb4000.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb4000.setSelected(mds3sectionI.isI4000());
	}
}
