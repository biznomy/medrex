...
public class PanelI0300 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1913994260595262143L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10300;
	...
	public PanelI0300() {
		...
		cb10300 = new JxCheckBox();
		cb10300.setTheme(theme);

		cb10300.setBounds(30, 2, 16, 16);
		panel_1.add(cb10300);
		cb10300.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI0300(cb10300.isSelected());
	...
	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10300.setSelected(mds3sectionI.isI0300());
	}
