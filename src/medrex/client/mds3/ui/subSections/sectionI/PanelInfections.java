...
public class PanelInfections extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 94570018873393061L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelInfections() {
		super();
