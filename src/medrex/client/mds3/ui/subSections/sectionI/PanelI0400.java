...
public class PanelI0400 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8533150539597680079L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10400;
	...
	public PanelI0400() {
		...
		cb10400 = new JxCheckBox();
		cb10400.setTheme(theme);

		cb10400.setBounds(30, 2, 16, 16);
		panel_1.add(cb10400);
		cb10400.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI0400(cb10400.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10400.setSelected(mds3sectionI.isI0400());
	}
