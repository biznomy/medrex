...
public class PanelHeartCirculation extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8446203720610683470L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelHeartCirculation() {
		super();
		...
		label.setText(" Heart/Circulation");
