...
public class PanelGastrointestinal extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 9207374934062145700L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelGastrointestinal() {
		super();
		...
		label.setText(" Gastrointestinal");
