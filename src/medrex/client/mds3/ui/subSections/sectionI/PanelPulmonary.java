...
public class PanelPulmonary extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8737814020663730573L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelPulmonary() {
		super();
