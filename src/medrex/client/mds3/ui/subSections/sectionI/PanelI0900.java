...
public class PanelI0900 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4849917806969575903L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10900;
	...
	public PanelI0900() {
		...
		cb10900 = new JxCheckBox();
		cb10900.setTheme(theme);

		cb10900.setBounds(30, 2, 16, 16);
		panel_1.add(cb10900);
		cb10900.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI0900(cb10900.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10900.setSelected(mds3sectionI.isI0900());
	}
}
