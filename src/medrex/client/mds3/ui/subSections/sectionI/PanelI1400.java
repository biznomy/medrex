...
public class PanelI1400 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1238945033105358374L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1400;
	...
	public PanelI1400() {
		...
		cb1400 = new JxCheckBox();
		cb1400.setTheme(theme);

		cb1400.setBounds(30, 2, 16, 16);
		panel_1.add(cb1400);
		cb1400.setText(" ");
		...
		label.setText("<html><b>11400. Benign Prostatic Hyperplasia(BPH)");
	...
	public void doSave() {
		...
		mds3sectionI.setI1400(cb1400.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1400.setSelected(mds3sectionI.isI1400());
	}
}
