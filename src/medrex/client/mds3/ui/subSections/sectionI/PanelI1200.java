...
public class PanelI1200 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1216193777222916003L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1200;
	...
	public PanelI1200() {
		...
		cb1200 = new JxCheckBox();
		cb1200.setTheme(theme);

		cb1200.setBounds(30, 2, 16, 16);
		panel_1.add(cb1200);
		cb1200.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI1200(cb1200.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1200.setSelected(mds3sectionI.isI1200());
	}
}
