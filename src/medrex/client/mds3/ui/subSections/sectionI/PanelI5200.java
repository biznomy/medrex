...
public class PanelI5200 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6652954393600750377L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5200;
	...
	public PanelI5200() {
		...
		cb5200 = new JxCheckBox();
		cb5200.setTheme(theme);

		cb5200.setBounds(30, 2, 16, 16);
		panel_1.add(cb5200);
		cb5200.setText(" ");
		...
		label.setText(" 15200 . Multiple Sclerosis (MS)");
	...
	public void doSave() {
		...
		mds3sectionI.setI5200(cb5200.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5200.setSelected(mds3sectionI.isI5200());
	}
}
