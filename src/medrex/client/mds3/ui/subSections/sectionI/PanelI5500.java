...
public class PanelI5500 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6741048361074202285L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5500;
	...
	public PanelI5500() {
		...
		cb5500 = new JxCheckBox();
		cb5500.setTheme(theme);

		cb5500.setBounds(30, 2, 16, 16);
		panel_1.add(cb5500);
		cb5500.setText(" ");
		...
		label.setText("15500. Traumatic Brain Injury (TBI) ");
		label.setBounds(10, 5, 598, 14);
		panel_2.add(label);
		doUpdate();
	}
	...
	public void doSave() {
		...
		mds3sectionI.setI5500(cb5500.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5500.setSelected(mds3sectionI.isI5500());
	}
}
