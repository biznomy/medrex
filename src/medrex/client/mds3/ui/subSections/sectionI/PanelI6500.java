...
public class PanelI6500 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 781809201866208378L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb6500;
	...
	public PanelI6500() {
		...
		cb6500 = new JxCheckBox();
		cb6500.setTheme(theme);

		cb6500.setBounds(30, 2, 16, 16);
		panel_1.add(cb6500);
		cb6500.setText(" ");
		...
		label
				.setText("<html><body> <b> 16500. Cataracts, Glaucoma, or Macular Degeneration ");
	...
	public void doSave() {
		...
		mds3sectionI.setI6500(cb6500.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb6500.setSelected(mds3sectionI.isI6500());
	}
}
