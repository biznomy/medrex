...
public class PanelI5250 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1706333464757516567L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5250;
	...
	public PanelI5250() {
		...
		cb5250 = new JxCheckBox();
		cb5250.setTheme(theme);

		cb5250.setBounds(30, 2, 16, 16);
		panel_1.add(cb5250);
		cb5250.setText(" ");
		...
		label.setText(" 15250 . Huntington's disease");
	...
	public void doSave() {
		...
		mds3sectionI.setI5250(cb5250.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5250.setSelected(mds3sectionI.isI5250());
	}
}
