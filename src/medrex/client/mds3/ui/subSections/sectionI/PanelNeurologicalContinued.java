...
public class PanelNeurologicalContinued extends JxPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6500191038260033619L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelNeurologicalContinued() {
		super();
		...
		label.setText(" Neurological - Continued");
