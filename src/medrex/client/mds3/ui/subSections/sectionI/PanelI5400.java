...
public class PanelI5400 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5951794759205796173L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5400;
	...
	public PanelI5400() {
		...
		cb5400 = new JxCheckBox();
		cb5400.setTheme(theme);

		cb5400.setBounds(30, 2, 16, 16);
		panel_1.add(cb5400);
		cb5400.setText(" ");
		...
		label.setText("15400. Seizure Disorder or Epilepsy ");
	...
	public void doSave() {
		...
		mds3sectionI.setI5400(cb5400.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5400.setSelected(mds3sectionI.isI5400());
	}
}
