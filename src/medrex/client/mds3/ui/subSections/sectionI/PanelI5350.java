...
public class PanelI5350 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5016752334282927887L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5350;
	...
	public PanelI5350() {
		...
		cb5350 = new JxCheckBox();
		cb5350.setTheme(theme);

		cb5350.setBounds(30, 2, 16, 16);
		panel_1.add(cb5350);
		cb5350.setText(" ");
		...
		label.setText("15350. Tourette's Syndrome ");
	...
	public void doSave() {
		...
		mds3sectionI.setI5350(cb5350.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5350.setSelected(mds3sectionI.isI5350());
	}
}
