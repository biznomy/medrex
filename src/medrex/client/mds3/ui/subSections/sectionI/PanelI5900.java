...
public class PanelI5900 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6117335416125527444L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5900;
	...
	public PanelI5900() {
		...
		cb5900 = new JxCheckBox();
		cb5900.setTheme(theme);

		cb5900.setBounds(30, 2, 16, 16);
		panel_1.add(cb5900);
		cb5900.setText(" ");
		...
		label.setText(" 15900. Manic Depression (other than bipolar)");
	...
	public void doSave() {
		...
		mds3sectionI.setI5900(cb5900.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5900.setSelected(mds3sectionI.isI5900());
	}
}
