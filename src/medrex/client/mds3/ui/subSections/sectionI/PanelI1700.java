...
public class PanelI1700 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8142012932498131001L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1700;
	...
	public PanelI1700() {
		...
		cb1700 = new JxCheckBox();
		cb1700.setTheme(theme);

		cb1700.setBounds(30, 2, 16, 16);
		panel_1.add(cb1700);
		cb1700.setText(" ");
		...
		label.setText("<html><b>11700. Multidrug - Resident Organism(MDRO)");
	...
	public void doSave() {
		...
		mds3sectionI.setI1700(cb1700.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1700.setSelected(mds3sectionI.isI1100());
	}
}
