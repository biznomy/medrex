...
public class PanelI0800 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3626828597958372098L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10800;
	...
	public PanelI0800() {
		...
		cb10800 = new JxCheckBox();
		cb10800.setTheme(theme);

		cb10800.setBounds(30, 2, 16, 16);
		panel_1.add(cb10800);
		cb10800.setText(" ");
		...
		label.setText("<html><b>10800. Orthosatatic Hypotension");
	...
	public void doSave() {
		...
		mds3sectionI.setI0400(cb10800.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10800.setSelected(mds3sectionI.isI0800());
	}
}
