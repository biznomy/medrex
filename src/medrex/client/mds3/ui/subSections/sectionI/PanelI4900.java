...
public class PanelI4900 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 9033378957381318400L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb4900;
	...
	public PanelI4900() {
		...
		cb4900 = new JxCheckBox();
		cb4900.setTheme(theme);

		cb4900.setBounds(30, 2, 16, 16);
		panel_1.add(cb4900);
		cb4900.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI4900(cb4900.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb4900.setSelected(mds3sectionI.isI4900());
	}
}
