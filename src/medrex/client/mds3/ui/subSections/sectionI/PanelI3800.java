...
public class PanelI3800 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1465907914067730118L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb3800;
	...
	public PanelI3800() {
		...
		cb3800 = new JxCheckBox();
		cb3800.setTheme(theme);

		cb3800.setBounds(30, 2, 16, 16);
		panel_1.add(cb3800);
		cb3800.setText(" ");
		...
		label.setText("<html><b>13800 Osteoporosis");
	...
	public void doSave() {
		...
		mds3sectionI.setI3800(cb3800.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb3800.setSelected(mds3sectionI.isI3800());
	}
