...
public class PanelI3100 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9094687598486674777L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb3100;
	...
	public PanelI3100() {
		...
		cb3100 = new JxCheckBox();
		cb3100.setTheme(theme);

		cb3100.setBounds(30, 2, 16, 16);
		panel_1.add(cb3100);
		cb3100.setText(" ");
		...
		label.setText("<html><b>13100. Hyponatremia");
	...
	public void doSave() {
		...
		mds3sectionI.setI3100(cb3100.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb3100.setSelected(mds3sectionI.isI3100());
	}
}
