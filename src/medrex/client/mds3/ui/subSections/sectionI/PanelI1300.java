...
public class PanelI1300 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8784116928706203127L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1300;
	...
	public PanelI1300() {
		...
		cb1300 = new JxCheckBox();
		cb1300.setTheme(theme);

		cb1300.setBounds(30, 2, 16, 16);
		panel_1.add(cb1300);
		cb1300.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI1300(cb1300.isSelected());
	}
	...
	public void doUpdate() {
		...
		cb1300.setSelected(mds3sectionI.isI1300());
	}
}
