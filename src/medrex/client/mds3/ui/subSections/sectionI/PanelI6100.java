...
public class PanelI6100 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -838703838183346185L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb6100;
	...
	public PanelI6100() {
		...
		cb6100 = new JxCheckBox();
		cb6100.setTheme(theme);

		cb6100.setBounds(30, 2, 16, 16);
		panel_1.add(cb6100);
		cb6100.setText(" ");
		...
		label.setText("16100. Post Traumatic Stress Disorder(PTSD) ");
	...
	public void doSave() {
		...
		mds3sectionI.setI6100(cb6100.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb6100.setSelected(mds3sectionI.isI6100());
	}
}
