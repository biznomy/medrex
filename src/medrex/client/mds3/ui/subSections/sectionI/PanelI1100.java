...
public class PanelI1100 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2297533245688592450L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1100;
	...
	public PanelI1100() {
		...
		cb1100 = new JxCheckBox();
		cb1100.setTheme(theme);

		cb1100.setBounds(30, 2, 16, 16);
		panel_1.add(cb1100);
		cb1100.setText(" ");
		...
		label.setText("<html><b>11100. Cirrhosis");
	...
	public void doSave() {
		...
		mds3sectionI.setI1100(cb1100.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1100.setSelected(mds3sectionI.isI0100());
	}
}
