...
public class PanelI0700 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4332945673284934266L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10700;
	...
	public PanelI0700() {
		...
		cb10700 = new JxCheckBox();
		cb10700.setTheme(theme);

		cb10700.setBounds(30, 2, 16, 16);
		panel_1.add(cb10700);
		cb10700.setText(" ");
		...
		label.setText("<html><b>10700. Hypertension");
	...
	public void doSave() {
		...
		mds3sectionI.setI0700(cb10700.isSelected());
	...
	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10700.setSelected(mds3sectionI.isI0700());
