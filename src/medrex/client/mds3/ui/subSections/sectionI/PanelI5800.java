...
public class PanelI5800 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3733176506300703657L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5800;
	...
	public PanelI5800() {
		...
		cb5800 = new JxCheckBox();
		cb5800.setTheme(theme);

		cb5800.setBounds(30, 2, 16, 16);
		panel_1.add(cb5800);
		cb5800.setText(" ");
		...
		label.setText("15800. Depression ");
	...
	public void doSave() {
		...
		mds3sectionI.setI5800(cb5800.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5800.setSelected(mds3sectionI.isI5800());
	}
}
