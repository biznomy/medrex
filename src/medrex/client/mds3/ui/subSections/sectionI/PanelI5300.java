...
public class PanelI5300 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7538822382760225080L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5300;
	...
	public PanelI5300() {
		...
		cb5300 = new JxCheckBox();
		cb5300.setTheme(theme);

		cb5300.setBounds(30, 2, 16, 16);
		panel_1.add(cb5300);
		cb5300.setText(" ");
		...
		label.setText(" 15300. Parkinson's Disease");
	...
	public void doSave() {
		...
		mds3sectionI.setI5300(cb5300.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5300.setSelected(mds3sectionI.isI5300());
	}
}
