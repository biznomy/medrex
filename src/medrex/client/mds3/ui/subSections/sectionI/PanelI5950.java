...
public class PanelI5950 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2199522683020893204L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5950;
	...
	public PanelI5950() {
		...
		cb5950 = new JxCheckBox();
		cb5950.setTheme(theme);

		cb5950.setBounds(30, 2, 16, 16);
		panel_1.add(cb5950);
		cb5950.setText(" ");
		...
		label.setText("15950. Psycotic Disorder ");
	...
	public void doSave() {
		...
		mds3sectionI.setI5950(cb5950.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5950.setSelected(mds3sectionI.isI5950());
	}
}
