...
public class PanelI2200 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 590839159966584597L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb2200;
	...
	public PanelI2200() {
		...
		cb2200 = new JxCheckBox();
		cb2200.setTheme(theme);

		cb2200.setBounds(30, 2, 16, 16);
		panel_1.add(cb2200);
		cb2200.setText(" ");
		...
		label.setText("<html><b>12200. Tuberculosis");
	...
	public void doSave() {
		...
		mds3sectionI.setI2200(cb2200.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb2200.setSelected(mds3sectionI.isI2200());
	}
