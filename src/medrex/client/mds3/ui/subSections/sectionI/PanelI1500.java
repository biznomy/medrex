...
public class PanelI1500 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1952556548948961276L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1500;
	...
	public PanelI1500() {
		...
		cb1500 = new JxCheckBox();
		cb1500.setTheme(theme);

		cb1500.setBounds(30, 2, 16, 16);
		panel_1.add(cb1500);
		cb1500.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI1500(cb1500.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1500.setSelected(mds3sectionI.isI1500());
	}
}
