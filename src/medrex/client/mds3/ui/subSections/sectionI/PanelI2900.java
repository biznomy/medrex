...
public class PanelI2900 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 633597339777655273L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb2900;
	...
	public PanelI2900() {
		...
		cb2900 = new JxCheckBox();
		cb2900.setTheme(theme);

		cb2900.setBounds(30, 2, 16, 16);
		panel_1.add(cb2900);
		cb2900.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI2900(cb2900.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb2900.setSelected(mds3sectionI.isI2900());
	}
