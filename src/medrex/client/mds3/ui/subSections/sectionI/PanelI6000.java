...
public class PanelI6000 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1621537255016232410L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb6000;
	...
	public PanelI6000() {
		...
		cb6000 = new JxCheckBox();
		cb6000.setTheme(theme);

		cb6000.setBounds(30, 2, 16, 16);
		panel_1.add(cb6000);
		cb6000.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI6000(cb6000.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb6000.setSelected(mds3sectionI.isI6000());
	}
}
