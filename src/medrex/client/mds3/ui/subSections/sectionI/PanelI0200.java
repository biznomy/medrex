...
public class PanelI0200 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5348375457110919428L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10200;
	...
	public PanelI0200() {
		...
		cb10200 = new JxCheckBox();
		cb10200.setTheme(theme);

		cb10200.setBounds(30, 2, 16, 16);
		panel_1.add(cb10200);
		cb10200.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI0200(cb10200.isSelected());
	...
	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10200.setSelected(mds3sectionI.isI0200());
	}
