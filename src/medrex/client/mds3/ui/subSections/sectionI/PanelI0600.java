...
public class PanelI0600 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2797633185933305183L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb10600;
	...
	public PanelI0600() {
		...
		cb10600 = new JxCheckBox();
		cb10600.setTheme(theme);

		cb10600.setBounds(30, 2, 16, 16);
		panel_1.add(cb10600);
		cb10600.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI0600(cb10600.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb10600.setSelected(mds3sectionI.isI0600());
	}
}
