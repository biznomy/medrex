...
public class PanelI5000 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1815919142545581277L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5000;
	...
	public PanelI5000() {
		...
		cb5000 = new JxCheckBox();
		cb5000.setTheme(theme);

		cb5000.setBounds(30, 2, 16, 16);
		panel_1.add(cb5000);
		cb5000.setText(" ");
		...
		label.setText(" 15000. Paraplegia");
	...
	public void doSave() {
		...
		mds3sectionI.setI5000(cb5000.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5000.setSelected(mds3sectionI.isI5000());
	}
}
