...
public class PanelNeurological extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4939949802625689439L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelNeurological() {
		super();
