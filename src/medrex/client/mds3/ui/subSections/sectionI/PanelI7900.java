...
public class PanelI7900 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1720905781080177725L;

	Theme theme = new BlackOverWhiteTheme();

	private JxCheckBox cb7900;
	...
	public PanelI7900() {
		...
		cb7900 = new JxCheckBox();
		cb7900.setTheme(theme);

		cb7900.setBounds(30, 2, 16, 16);
		panel_1.add(cb7900);
		cb7900.setText(" ");
		...
		label
				.setText("<html><body><b> 17900. None of the above active dignoses </b> within the the last 7 days ");
	...
	public void doSave() {
		...
		mds3sectionI.setI7900(cb7900.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb7900.setSelected(mds3sectionI.isI7900());
	}
}
