...
public class PanelI1650 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 392738201288367517L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb1650;
	...
	public PanelI1650() {
		...
		cb1650 = new JxCheckBox();
		cb1650.setTheme(theme);

		cb1650.setBounds(30, 2, 16, 16);
		panel_1.add(cb1650);
		cb1650.setText(" ");
		...
		label.setText("<html><b>11650. Obstructive Uropathy");
	...
	public void doSave() {
		...
		mds3sectionI.setI1100(cb1650.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb1650.setSelected(mds3sectionI.isI1650());
	}
}
