...
public class PanelNutritional extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2814618419315527879L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelNutritional() {
		super();
