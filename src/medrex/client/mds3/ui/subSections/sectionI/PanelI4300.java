...
public class PanelI4300 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8755553808148641714L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb4300;
	...
	public PanelI4300() {
		...
		cb4300 = new JxCheckBox();
		cb4300.setTheme(theme);

		cb4300.setBounds(30, 2, 16, 16);
		panel_1.add(cb4300);
		cb4300.setText(" ");
		...
		label.setText("<html><b>14300. Aphasia");
	...
	public void doSave() {
		...
		mds3sectionI.setI4300(cb4300.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb4300.setSelected(mds3sectionI.isI4300());
	}
}
