...
public class PanelGenitourinary extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 9003928353809383386L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelGenitourinary() {
		super();
