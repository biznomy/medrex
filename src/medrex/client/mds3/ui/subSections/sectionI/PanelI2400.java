...
public class PanelI2400 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8412612418783261859L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb2400;
	...
	public PanelI2400() {
		...
		cb2400 = new JxCheckBox();
		cb2400.setTheme(theme);

		cb2400.setBounds(30, 2, 16, 16);
		panel_1.add(cb2400);
		cb2400.setText(" ");
		...
		label.setText("<html><b>12400. Virul Hepatitis</b>(eg Hep- A,B,C,D,E)");
	...
	public void doSave() {
		...
		mds3sectionI.setI2400(cb2400.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb2400.setSelected(mds3sectionI.isI2400());
	}
}
