...
public class PanelMetabolic extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1967299459988116553L;
	Theme theme = new BlackOverWhiteTheme();

	public PanelMetabolic() {
		super();
