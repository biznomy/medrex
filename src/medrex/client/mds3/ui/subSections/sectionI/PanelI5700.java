...
public class PanelI5700 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4870663178906700288L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb5700;
	...
	public PanelI5700() {
		...
		cb5700 = new JxCheckBox();
		cb5700.setTheme(theme);

		cb5700.setBounds(30, 2, 16, 16);
		panel_1.add(cb5700);
		cb5700.setText(" ");
		...
		label.setText(" 15700. Anxiety Disorder");
	...
	public void doSave() {
		...
		mds3sectionI.setI5700(cb5700.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb5700.setSelected(mds3sectionI.isI5700());
	}
}
