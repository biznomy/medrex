...
public class PanelI3300 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9069909202212458284L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb3300;
	...
	public PanelI3300() {
		...
		cb3300 = new JxCheckBox();
		cb3300.setTheme(theme);

		cb3300.setBounds(30, 2, 16, 16);
		panel_1.add(cb3300);
		cb3300.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI3300(cb3300.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb3300.setSelected(mds3sectionI.isI3300());
	}
}
