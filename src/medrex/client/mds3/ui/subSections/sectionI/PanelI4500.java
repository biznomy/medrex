...
public class PanelI4500 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4766729404746832667L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb4500;
	...
	public PanelI4500() {
		...
		cb4500 = new JxCheckBox();
		cb4500.setTheme(theme);

		cb4500.setBounds(30, 2, 16, 16);
		panel_1.add(cb4500);
		cb4500.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI4500(cb4500.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb4500.setSelected(mds3sectionI.isI4500());
	}
}
