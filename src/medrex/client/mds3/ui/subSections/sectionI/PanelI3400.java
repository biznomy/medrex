...
public class PanelI3400 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5065611985247996752L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb3400;
	...
	public PanelI3400() {
		...
		cb3400 = new JxCheckBox();
		cb3400.setTheme(theme);

		cb3400.setBounds(30, 2, 16, 16);
		panel_1.add(cb3400);
		cb3400.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI3400(cb3400.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb3400.setSelected(mds3sectionI.isI3400());
	}
}
