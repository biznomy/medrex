...
public class PanelI3700 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1971599544311998276L;
	Theme theme = new BlackOverWhiteTheme();
	private JxCheckBox cb3700;
	...
	public PanelI3700() {
		...
		cb3700 = new JxCheckBox();
		cb3700.setTheme(theme);

		cb3700.setBounds(30, 2, 16, 16);
		panel_1.add(cb3700);
		cb3700.setText(" ");
	...
	public void doSave() {
		...
		mds3sectionI.setI3700(cb3700.isSelected());
	}

	public void doUpdate() {
		Mds3SectionI mds3sectionI = (Mds3SectionI) Mds3Controller.getInstance()
				.getSection(Mds3SectionI.class);
		cb3700.setSelected(mds3sectionI.isI3700());
	}
}
