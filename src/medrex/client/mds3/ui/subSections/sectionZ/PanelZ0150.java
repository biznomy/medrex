...
public class PanelZ0150 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2710764259067961080L;
	Theme theme = new BlackOverWhiteTheme();
	private JxText txtZ0150B;
	private JxText txtZ0150A;
	...
	public PanelZ0150() {
		...
		z0100MedicarePartLabel
				.setText("Z0150.   Medicare Part A Non-Therapy Billing");
		...
		aLabel
				.setText("<html><body><b> A. </b> &nbsp <b> Medicare Part A non-therapy HIPPS code </b> (RUG group followed by assessment type indicatior) :");
		...
		txtZ0150A = new JxText();
		txtZ0150A.setTheme(theme);
		txtZ0150A.setBounds(30, 30, 225, 22);
		panel_4.add(txtZ0150A);

		txtZ0150B = new JxText();
		txtZ0150B.setTheme(theme);
		txtZ0150B.setBounds(30, 84, 225, 22);
		panel_4.add(txtZ0150B);
		doUpdate();
	}
	...
	public void doSave() {
		...
		mds3sectionZ.setZ0150A(txtZ0150A.getText());
		mds3sectionZ.setZ0150B(txtZ0150B.getText());
	...
	public void doUpdate() {
		...
		txtZ0150A.setText(mds3sectionZ.getZ0150A());
		txtZ0150B.setText(mds3sectionZ.getZ0150B());
