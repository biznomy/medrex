...
public class PanelZ0200 extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8063622220410586279L;
	Theme theme = new BlackOverWhiteTheme();
	private JxText txtZ0200B;
	private JxText txtZ0200A;
	...
	public PanelZ0200() {
		...
		z0100MedicarePartLabel
				.setText("Z0200.   State Medicaid Billing (if required by the state)");
		...
		txtZ0200A = new JxText();
		txtZ0200A.setTheme(theme);
		txtZ0200A.setBounds(30, 30, 225, 22);
		panel_4.add(txtZ0200A);

		txtZ0200B = new JxText();
		txtZ0200B.setTheme(theme);
		txtZ0200B.setBounds(30, 84, 225, 22);
		panel_4.add(txtZ0200B);
		doUpdate();
	}
	...
	public void doSave() {
		...
		mds3sectionZ.setZ0200A(txtZ0200A.getText());
		mds3sectionZ.setZ0200B(txtZ0200B.getText());
	...
	public void doUpdate() {
		...
		txtZ0200A.setText(mds3sectionZ.getZ0200A());
		txtZ0200B.setText(mds3sectionZ.getZ0200B());
