...
public class PanelO0400B extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6542167977223134859L;
	Theme theme = new BlackOverWhiteTheme();
	private JxDateChooser dcO0400B6;
	private JxDateChooser dcO0400B5;
	private JxText txtO0400B4;
	private JxText txtO0400B3;
	private JxText txtO0400B2;
	private JxText txtO0400B1;

	public PanelO0400B() {
		super();
		setPreferredSize(new Dimension(840, 285));
		setLayout(null);
		...
		txtO0400B1 = new JxText();
		txtO0400B1.setTheme(theme);
		txtO0400B1.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400B1.setBounds(33, 30, 60, 20);
		panel_2.add(txtO0400B1);

		txtO0400B2 = new JxText();
		txtO0400B2.setTheme(theme);
		txtO0400B2.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400B2.setBounds(33, 75, 60, 20);
		panel_2.add(txtO0400B2);

		txtO0400B3 = new JxText();
		txtO0400B3.setTheme(theme);
		txtO0400B3.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400B3.setBounds(33, 115, 60, 20);
		panel_2.add(txtO0400B3);

		txtO0400B4 = new JxText();
		txtO0400B4.setTheme(theme);
		txtO0400B4.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400B4.setBounds(33, 180, 60, 20);
		panel_2.add(txtO0400B4);
		...
		aSpeechlanguageLabel.setText(" B.  Occupational Therapy ");
		...
		label_1
				.setText("<html><body><b> If the sum of individual , concurrent, and group minutes is zero , -></b> skip to O0400C, Physical Therapy");
		label_1.setBounds(10, 140, 669, 27);
		panel_5.add(label_1);
		...
		dcO0400B5 = new JxDateChooser();
		dcO0400B5.setTheme(theme);
		dcO0400B5.setDateFormatString("MM/dd/yyyy");
		dcO0400B5.setBounds(50, 245, 160, 20);
		panel_5.add(dcO0400B5);

		dcO0400B6 = new JxDateChooser();
		dcO0400B6.setTheme(theme);
		dcO0400B6.setDateFormatString("MM/dd/yyyy");
		dcO0400B6.setBounds(435, 245, 160, 20);
		panel_5.add(dcO0400B6);
		doUpdate();
	...
	public void doSave() {
		...
		sectionO.setO0400B1(getDouble(txtO0400B1.getText()));
		sectionO.setO0400B2(getDouble(txtO0400B2.getText()));
		sectionO.setO0400B3(getDouble(txtO0400B3.getText()));
		sectionO.setO0400B4(getDouble(txtO0400B4.getText()));
		sectionO.setO0400B5((dcO0400B5.getDate()));
		sectionO.setO0400B6((dcO0400B6.getDate()));
	}
	...
	public void doUpdate() {
		Mds3SectionO mds3SectionO = (Mds3SectionO) Mds3Controller.getInstance()
				.getSection(Mds3SectionO.class);
		txtO0400B1.setText(mds3SectionO.getO0400B1() + "");
		txtO0400B2.setText(mds3SectionO.getO0400B2() + "");
		txtO0400B3.setText(mds3SectionO.getO0400B3() + "");
		txtO0400B4.setText(mds3SectionO.getO0400B4() + "");
		dcO0400B5.setDate(mds3SectionO.getO0400B5());
		dcO0400B6.setDate(mds3SectionO.getO0400B6());
