...
public class PanelO0400C extends JxPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5633926067721652071L;
	Theme theme = new BlackOverWhiteTheme();
	private JxDateChooser dcO0400C6;
	private JxDateChooser dcO0400C5;
	private JxText txtO0400C4;
	private JxText txtO0400C3;
	private JxText txtO0400C2;
	private JxText txtO0400C1;
	...
	public PanelO0400C() {
		...
		txtO0400C1 = new JxText();
		txtO0400C1.setTheme(theme);
		txtO0400C1.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400C1.setBounds(33, 30, 60, 20);
		panel_2.add(txtO0400C1);

		txtO0400C2 = new JxText();
		txtO0400C2.setTheme(theme);
		txtO0400C2.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400C2.setBounds(33, 75, 60, 20);
		panel_2.add(txtO0400C2);

		txtO0400C3 = new JxText();
		txtO0400C3.setTheme(theme);
		txtO0400C3.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400C3.setBounds(33, 115, 60, 20);
		panel_2.add(txtO0400C3);

		txtO0400C4 = new JxText();
		txtO0400C4.setTheme(theme);
		txtO0400C4.setBorder(new LineBorder(Mds3Constants.BORDER_BLACK,
				Mds3Constants.BORDER_SIZE_1, false));
		txtO0400C4.setBounds(33, 180, 60, 20);
		panel_2.add(txtO0400C4);
		...
		aSpeechlanguageLabel.setText(" C.  Physical Therapy ");
		...
		label_1
				.setText("<html><body><b> If the sum of individual , concurrent, and group minutes is zero , -> </b> skip to O0400D, Respiratory Therapy");
		...
		dcO0400C5 = new JxDateChooser();
		dcO0400C5.setTheme(theme);
		dcO0400C5.setDateFormatString("MM/dd/yyyy");
		dcO0400C5.setBounds(50, 245, 160, 20);
		panel_5.add(dcO0400C5);

		dcO0400C6 = new JxDateChooser();
		dcO0400C6.setTheme(theme);
		dcO0400C6.setDateFormatString("MM/dd/yyyy");
		dcO0400C6.setBounds(435, 245, 160, 20);
		panel_5.add(dcO0400C6);
		doUpdate();
	...
	public void doSave() {
		...
		sectionO.setO0400C1(getDouble(txtO0400C1.getText()));
		sectionO.setO0400C2(getDouble(txtO0400C2.getText()));
		sectionO.setO0400C3(getDouble(txtO0400C3.getText()));
		sectionO.setO0400C4(getDouble(txtO0400C4.getText()));
		sectionO.setO0400C5((dcO0400C5.getDate()));
		sectionO.setO0400C6((dcO0400C6.getDate()));
	}
	...
	public void doUpdate() {
		Mds3SectionO mds3SectionO = (Mds3SectionO) Mds3Controller.getInstance()
				.getSection(Mds3SectionO.class);
		txtO0400C1.setText(mds3SectionO.getO0400C1() + "");
		txtO0400C2.setText(mds3SectionO.getO0400C2() + "");
		txtO0400C3.setText(mds3SectionO.getO0400C3() + "");
		txtO0400C4.setText(mds3SectionO.getO0400C4() + "");
		dcO0400C5.setDate(mds3SectionO.getO0400C5());
		dcO0400C6.setDate(mds3SectionO.getO0400C6());
