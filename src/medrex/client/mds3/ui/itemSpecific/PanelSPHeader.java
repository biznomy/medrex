...
public class PanelSPHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1897921608683543332L;

	public PanelSPHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1.setText("Swing Bed PPS (SP) Item Set");
