...
public class PanelNCHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8390938230387260190L;

	public PanelNCHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel.setFont(new Font("Arial", Font.BOLD, 16));
