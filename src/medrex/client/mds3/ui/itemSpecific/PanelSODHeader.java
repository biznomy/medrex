...
public class PanelSODHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2937403938776001594L;

	public PanelSODHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Swing Bed OMRA-Discharge (SOD) Item Set");
