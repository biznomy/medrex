...
public class PanelNDHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2721023198557999342L;

	public PanelNDHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Nursing Home Discharge (ND) Item Set");
