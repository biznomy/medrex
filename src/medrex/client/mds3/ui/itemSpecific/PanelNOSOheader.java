...
public class PanelNOSOheader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 340848335932122975L;

	public PanelNOSOheader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Nursing Home and Swing Bed OMRA (NO/SO) Item Set");
