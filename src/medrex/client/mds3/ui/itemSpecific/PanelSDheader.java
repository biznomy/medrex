...
public class PanelSDheader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -855969275769606665L;

	public PanelSDheader() {
		...
		residentAssessmentAndLabel_1
				.setText("Swing Bed Discharge (SD) Item Set");
