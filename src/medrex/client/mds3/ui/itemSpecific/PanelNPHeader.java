...
public class PanelNPHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8921084361041318933L;

	public PanelNPHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1.setText("Nursing Home PPS (NP) Item Set");
