...
public class PanelNQheader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1867525428227826948L;

	public PanelNQheader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Nursing Home Quarterly (NQ) Item Set");
