...
public class PanelNSSSHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5886290215144527101L;

	public PanelNSSSHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Nursing Home and Swing Bed OMRA-Start of Therapy (NS/SS) Item Set");
		residentAssessmentAndLabel_1.setBounds(139, 65, 565, 16);
