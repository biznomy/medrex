...
public class PanelNODHeader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3710807818338899511L;

	public PanelNODHeader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Nursing Home OMRA-Discharge (NOD) Item Set");
