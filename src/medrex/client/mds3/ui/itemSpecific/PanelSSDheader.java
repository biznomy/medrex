...
public class PanelSSDheader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4855499318214830554L;

	public PanelSSDheader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Swing Bed OMRA -Start of Therapy and Discharge (SSD) Item Set");
		residentAssessmentAndLabel_1.setBounds(158, 65, 502, 16);
