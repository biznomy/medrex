...
public class PanelNTSTheader extends JPanel implements Mds3SubSection {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3633505306781892591L;

	public PanelNTSTheader() {
		super();
		setOpaque(false);
		...
		residentAssessmentAndLabel_1
				.setText("Nursing Home and Swing Bed Tracking (NT/ST) Item Set");
