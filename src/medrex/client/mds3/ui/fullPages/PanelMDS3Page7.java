...
public class PanelMDS3Page7 extends JPanel implements Form {
	/**
	 * 
	 */
	private static final long serialVersionUID = 816559759713991209L;

	public PanelMDS3Page7() {
		super();
		...
		a0100Label_2
				.setText("C0600. Should the Staff Assessment for mental status(C0700-C100) be Conducted?");
		...
		aNationalProviderLabel_1_3
				.setText("<html><body>01. <b>Yes</b> (the resident was unable to complete the interview) Continue to C0700 , Short term memory OK");
		...
		panel_1_1_1.setPreferredSize(new Dimension(820, 570));
		...
		panel_7_1.setBounds(91, 10, 719, 68);
		panel_1_1.add(panel_7_1);

		final JLabel aNationalProviderLabel_3_1 = new JLabel();
		aNationalProviderLabel_3_1.setFont(new Font("Arial", Font.BOLD, 12));
		...
		aNationalProviderLabel_1_3_1.setText("<html><body>0. <b>Memory OK");
		...
		aNationalProviderLabel_1_3_1_1
				.setText("<html><body>1. <b>Memory Problem");
		...
		panel_6_1_1.setBorder(new LineBorder(ColorConstants.MDS_FONT_COLOR, 1,
				false));
		panel_6_1_1.setBounds(0, 29, 84, 72);
		...
		aNationalProviderLabel_3_1_1
				.setText("Seems or appear to recall long past");
		...
		aNationalProviderLabel_1_3_1_2.setText("<html><body>0. <b>Memory OK");
		...
		panel_5_1_1_2_1_1.setBounds(0, 30, 820, 20);
		...
		panel_5_1_1_2_1_1_1.setBounds(84, 50, 736, 20);
		panel_1_1_2_1.add(panel_5_1_1_2_1_1_1);

		final JLabel a0100Label_1_1_2_1_1_1 = new JLabel();
		a0100Label_1_1_2_1_1_1.setFont(new Font("Arial", Font.BOLD, 12));
		...
		panel_5_1_1_2_1_1_1_1.setBounds(84, 70, 736, 20);
		panel_1_1_2_1.add(panel_5_1_1_2_1_1_1_1);

		final JLabel a0100Label_1_1_2_1_1_1_1 = new JLabel();
		a0100Label_1_1_2_1_1_1_1.setFont(new Font("Arial", Font.BOLD, 12));
		...
		panel_5_1_1_2_1_1_1_2.setBounds(84, 90, 736, 20);
		...
		panel_5_1_1_2_1_1_1_3.setBounds(84, 110, 736, 20);
		...
		panel_5_1_1_2_1_1_1_4.setBounds(84, 130, 736, 20);
		...
		panel_1_1_2_2.setPreferredSize(new Dimension(820, 150));
		...
		panel_6_1_1_2.setBounds(0, 29, 84, 121);
		...
		comboBox_1_1.setBounds(17, 31, 50, 20);
		panel_6_1_1_2.add(comboBox_1_1);
		...
		panel_7_1_1_1.setBounds(83, 29, 737, 121);
		...
		aNationalProviderLabel_1_3_1_2_1
				.setText("<html>0. <b>Independant - </b> decisions consistent/reasonable");
		...
		aNationalProviderLabel_1_3_1_1_1_1
				.setText("<html>1. <b>Modified independance - </b> some difficulty in new situations only");
		...
		aNationalProviderLabel_1_3_1_1_1_1_1
				.setText("<html>2. <b>Moderately impaired - </b>decisions poor ; cues/ supervision required");
		...
		aNationalProviderLabel_1_3_1_1_1_1_2
				.setText("<html>3. <b>severely impaired - </b>never / rarely made decisions");
		...
		panel_5_1_1_2_2.setBounds(0, 0, 820, 30);
		panel_1_1_2_2.add(panel_5_1_1_2_2);

		final JLabel a0100Label_1_1_2_2 = new JLabel();
		a0100Label_1_1_2_2.setFont(new Font("Arial", Font.BOLD, 12));
		a0100Label_1_1_2_2
		...
		panel_7_2_1.setBounds(91, 30, 739, 47);
		...
		aNationalProviderLabel_1_3_2.setBounds(10, 25, 62, 14);
