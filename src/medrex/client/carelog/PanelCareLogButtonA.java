...
public class PanelCareLogButtonA extends JxPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6552451058267677205L;
	...
	public PanelCareLogButtonA(String img, final int level) {
		super();
		...
		panelImg.setBounds(48, 10, 130, 63);
		add(panelImg);
		...
		txtText.setBounds(10, 10, 163, 35);
		add(txtText);
		...
		panelResult.setBounds(10, 50, 180, 27);
		add(panelResult);
