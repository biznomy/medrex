...
public class PhoneField extends JPanel {
	...
	public PhoneField() {
		...
		txtField02 = new JFormattedTextField(FieldFormatter.MAX3);
		...
		txtField02.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(final KeyEvent e) {
				if (txtField02.getText().length() <= 2) {
					txtField02.requestFocus();
					text2 = txtField02.getText();
				} else if (txtField02.getText().length() == 3) {
					text2 = txtField02.getText();
	...
	protected void resize() {
		...
		txtField02.setBounds((int) (bW + wh * 3) + sepW, bW, (int) (wh * 3), h);
		lblSeparator02.setBounds((int) (bW + wh * 6) + sepW, bW * 2, sepW, h
				- 3 * bW);
		txtField03.setBounds((int) (bW + wh * 6 + sepW * 2), bW,
				(int) (wh * 4), h);
	}
	...
	public void setNumber(String phoneNum) {
		try {
			...
			txtField02.setText(phoneNum.substring(3, 6));
			txtField03.setText(phoneNum.substring(6, 10));
