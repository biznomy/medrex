...
public class MedicationResidentListCell extends JPanel implements
		ListCellRenderer {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7591219211498934411L;
	private JLabel selRectagle;
	private JLabel lblMedicationTime;
	private JLabel lblResidentName;

	public MedicationResidentListCell() {
		setLayout(null);
		setSize(706, 50);
		add(getSelRectagle());
