...
public final class MsgBoxTouchScreen extends JDialog implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7283602456661759413L;
	...
	private static Font DEFAULT_FONT = new Font("", Font.BOLD, 18);
	private static final LineBorder DEFAULT_BORDER = new LineBorder(Color.BLUE,
			5, false);
	...
	// constructors
	private MsgBoxTouchScreen() {
		super();
		constructLayout(ScreenLayout.OKONLY);
	}

	MsgBoxTouchScreen(Font defaultFont) {
		this();
	...
	private void constructLayout(ScreenLayout s) {
		...
		msgPanel.setBounds(10, 10, 509, 154);
	...
	private Icon getIcon(Severity s) {
		switch (s) {
		case ERROR:
	...
	private JComponent createPrompt(String message, Severity s) {
		...
		promptIcon.setText("<html><body><p style='text-align:justify'>"
				+ message + "</p></body></html>");
	...
	public static void ShowValidation(ValidationResult vr, String title) {
		MsgBoxTouchScreen m = new MsgBoxTouchScreen();
		m.setTitle(title);
	...
	public static void main(String[] a) {
		...
		System.out.println(ShowLayout("Do you want to add this entry?",
				"Title", MsgBoxTouchScreen.ScreenLayout.YESNOCANCEL));
	}
}
