...
public class FrameClientUpdater extends JFrame {
	...
	public FrameClientUpdater() {
		...
		label.setText("MEDREX CLIENT AUTO UPDATER");
		label.setBounds(60, 21, 310, 25);
	...
	public void extractMedrex() throws MedrexException {
		lblmessage.setText("Installing Medrex");
		Unzipper unzipper = new Unzipper();
		unzipper.recursiveUnzip(new File("C:\\medrextmp\\medrex.zip"),
	...
	public void updateVersion() throws MedrexException {
		...
		FTPDownload.downloadFile("version.txt");
		String strLine = "";

		try {
			FileInputStream fstream = new FileInputStream(
					"c:\\medrextmp\\version.txt");
	...
	public void downloadMedrex() throws MedrexException {
		...
		lblmessage.setText("Downloading Latest Version of Medrex");

		FTPDownload.downloadFile("medrex.zip");
