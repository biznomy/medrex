...
public class PanelDnrDnhForm extends JPanel implements Form {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3606274472155244139L;
	private JxLabel jhgjgjghJxLabel_1;
	...
	private JxTextA textAreaDiagnosis;
	private JxLabel jxLabel_2;
	private JxLabel jxLabel_1;
	private JxLabel jxLabelNursingHome;
	...
	public PanelDnrDnhForm() {
		...
		jxLabelNursingHome = new JxLabel();
		jxLabelNursingHome.setHorizontalAlignment(SwingConstants.CENTER);
		jxLabelNursingHome.setTheme(theme);
		jxLabelNursingHome.setFontSize(14);
		jxLabelNursingHome.setFontStyle(Font.BOLD);
		jxLabelNursingHome.setText("Plaza Healthcare and Rehabilitation Center");
		jxLabelNursingHome.setBounds(49, 10, 710, 14);
		jxPanel_1.add(jxLabelNursingHome);

		jxLabel_1 = new JxLabel();
		jxLabel_1.setTheme(theme);
		jxLabelNursingHome.setFontSize(18);
		jxLabelNursingHome.setFontStyle(Font.BOLD);
		jxLabel_1.setText("PHYSICIAN PROGRESS NOTES");
		jxLabel_1.setBounds(328, 30, 199, 14);
		...
		jxLabelNursingHome.setFontSize(18);
		jxLabelNursingHome.setFontStyle(Font.BOLD);
		jxLabel_2.setText("DO NOT RESUSCITATE / DO NOT HOSPITALIZE");
		jxLabel_2.setBounds(284, 50, 267, 14);
		...
		residentNameJxLabel.setBounds(10, 12, 100, 14);
		...
		lblResidentName.setBounds(130, 10, 100, 20);
		jxPanel_2.add(lblResidentName);
		...
		diagnosisJxLabel.setBounds(10, 37, 100, 14);
		jxPanel_2.add(diagnosisJxLabel);

		textAreaDiagnosis = new JxTextA();
		textAreaDiagnosis.setBounds(130, 35, 770, 30);
		Border lineBdr5 = BorderFactory.createLineBorder(Color.LIGHT_GRAY);
		textAreaDiagnosis.setBorder(lineBdr5);
		jxPanel_2.add(textAreaDiagnosis);
		...
		jxCheckBox.setBounds(10, 10, 297, 14);
		...
		jxCheckBox_1.setBounds(10, 34, 424, 14);
		...
		jxCheckBox_2.setBounds(10, 58, 492, 14);
		...
		jxCheckBox_3.setBounds(10, 82, 575, 14);
		...
		jxCheckBox_4.setBounds(10, 106, 510, 14);
		...
		gdfgJxText = new JxText();
		gdfgJxText.setText("");
		gdfgJxText.setTheme(theme);
		gdfgJxText.setBounds(142, 128, 239, 20);
		jxPanel_5.add(gdfgJxText);
		...
		gdfgJxText_1 = new JxText();
		gdfgJxText_1.setText("");
		gdfgJxText_1.setTheme(theme);
		gdfgJxText_1.setBounds(215, 28, 100, 20);
		jxPanel_7.add(gdfgJxText_1);
		...
		jxPanel_8.setBounds(10, 57, 870, 93);
		...
		jxPanel_14.setBounds(11, 10, 270, 40);
		...
		jxPanel_14_3.setBounds(11, 50, 270, 40);
		...
		final JxText gfdgdfgJxText = new JxText();
		gfdgdfgJxText.setText("");
		gfdgdfgJxText.setTheme(theme);
		gfdgdfgJxText.setBounds(142, 199, 100, 20);
		jxPanel_7.add(gfdgdfgJxText);
		...
		nursingStaffJxCheckBox_1.setBounds(33, 0, 356, 14);
		...
		nursingStaffJxCheckBox_2.setBounds(33, 0, 319, 14);
		...
		aJxLabel_2.setBounds(10, 4, 17, 14);
		...
		aJxLabel_3.setBounds(10, 6, 17, 14);
		...
		jxLabel_7.setBounds(10, 194, 790, 14);
		...
		physicianSignatureJxLabel.setBounds(10, 10, 144, 14);
		...
		jxDateChooser.setBounds(725, 8, 135, 20);
		jxPanel_13_1.add(jxDateChooser);

		final JxLabel dateJxLabel = new JxLabel();
		dateJxLabel.setTheme(theme);
		dateJxLabel.setText("Date");
		dateJxLabel.setBounds(692, 10, 34, 14);
		jxPanel_13_1.add(dateJxLabel);

		jhgjgjghJxLabel_1 = new JxLabel();
		jhgjgjghJxLabel_1.setText("");
		jhgjgjghJxLabel_1.setBounds(125, 6, 100, 20);
		jxPanel_13_1.add(jhgjgjghJxLabel_1);
		...
		dateJxLabel_1.setBounds(692, 10, 33, 14);
		...
		jxLabel_11.setBounds(10, 10, 304, 14);
		...
		dateJxLabel_2.setBounds(692, 30, 34, 14);
	...
	public void doUpdate() {
		...
		jxLabelNursingHome.setText(nh.getName());
		}
		catch(Exception ee){
