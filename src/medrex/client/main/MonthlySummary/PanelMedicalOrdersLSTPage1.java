...
public class PanelMedicalOrdersLSTPage1 extends JPanel implements Form {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3282904542020261432L;
	...
	public PanelMedicalOrdersLSTPage1() {
		...
		lblFName.setText("");
		lblFName.setBounds(141, 0, 100, 14);
		jxPanel_2.add(lblFName);
		...
		lblLastName.setBounds(10, 0, 91, 14);
		...
		lblSectionC.setBounds(0, 10, 90, 17);
	...
	public void doUpdate() {
		...
		lblLName.setText(rm.getUserPass());
		lblFName.setText(rm.getUserName());
	}
