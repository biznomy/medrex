package medrex.client.main.newform;
...
public class PanelResidentInformation extends JPanel implements Form {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4388225969401602129L;
	...
	public PanelResidentInformation() {
		...
		final JTextField txtCane = new JTextField();
		...
		final JTextField txtCrutches = new JTextField();
		...
		final JTextField txtProsthesis = new JTextField();
		...
		final JTextField txtWalker = new JTextField();
		...
		final JTextField txtChair = new JTextField();
		...
		final JTextField txtHearingR = new JTextField();
		...
		final JTextField txtHearingL = new JTextField();
		...
		final JTextField txtDenturesUpper = new JTextField();
		...
		final JTextField txtLower = new JTextField();
		...
		final JTextField txtGlassess = new JTextField();
	...
	public int doSave() {
		/*
		 * ResidentInformation refResidentInformation = new
		 * ResidentInformation(); //
		 ...
		 * 
		 * 
		 * refResidentInformation.setUnderstandEnglish(SwingUtils.getSelectedButton
		 * (bgUnderstandEnglish));
		 * refResidentInformation.setGestures(SwingUtils.
		 * getSelectedButton(bgGestures));
		 * refResidentInformation.setUnderstandWriting
		 * (SwingUtils.getSelectedButton(bgUnderstandWriting));
		 * refResidentInformation
		 * .setUnderstandSpeaking(SwingUtils.getSelectedButton
		 * (bgUnderstandSpeaking));
		 ...
		 * refResidentInformation.setAbletoMake(
		 * SwingUtils.getSelectedButton(bgAbletoMake));
		 * refResidentInformation.setSideRails
		 * (SwingUtils.getSelectedButton(bgSideRails));
		 ...
		 * refResidentInformation
		 * .setPersonalHygiene1(txtPersonalHygiene1.getText());
		 * refResidentInformation
		 * .setPersonalHygiene4(txtPersonalHygiene4.getText());
		 * refResidentInformation
		 * .setPersonalHygiene7(txtPersonalHygiene7.getText());
		 * refResidentInformation
		 * .setPersonalHygiene10(txtPersonalHygiene10.getText());
		 * refResidentInformation
		 * .setPersonalHygiene13(txtPersonalHygiene13.getText());
		 * refResidentInformation
		 * .setPersonalHygiene2(txtPersonalHygiene2.getText());
		 * refResidentInformation
		 * .setPersonalHygiene5(txtPersonalHygiene5.getText());
		 * refResidentInformation
		 * .setPersonalHygiene8(txtPersonalHygiene8.getText());
		 * refResidentInformation
		 * .setPersonalHygiene11(txtPersonalHygiene11.getText());
		 * refResidentInformation
		 * .setPersonalHygiene14(txtPersonalHygiene14.getText());
		 * refResidentInformation
		 * .setPersonalHygiene3(txtPersonalHygiene3.getText());
		 * refResidentInformation
		 * .setPersonalHygiene6(txtPersonalHygiene6.getText());
		 * refResidentInformation
		 * .setPersonalHygiene9(txtPersonalHygiene9.getText());
		 * refResidentInformation
		 * .setPersonalHygiene12(txtPersonalHygiene12.getText());
		 * refResidentInformation
		 * .setPersonalHygiene15(txtPersonalHygiene15.getText());
		 ...
		 * refResidentInformation
		 * .setSocialInformation(txtSocialInformation.getText()); //
		 * refResidentInformation
		 * .setAdditionalPertinent(txtAdditionalPertinent.getText());
		 */return 0;
	}
