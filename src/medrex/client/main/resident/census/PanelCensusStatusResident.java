...
public class PanelCensusStatusResident extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6009295160292666032L;
	...
	public void doUpdate() {
		...
		if (refCensusStatus != null) {
			...
			lblSignInStatus.setForeground(refCensusStatus.getSignInSeverity()
					.getColor());
			lblOutOfPassStatus.setText(/*
										 * refCensusStatus.getOutOnPassStatusDesc
										 * ()
										 */"none");
	...
	public boolean isDischargedToHospital() {
