...
public class CopyOfPanelAddNewPhysician extends JxPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -561779225960633002L;
	...
	public CopyOfPanelAddNewPhysician() {
		super();
	...
	public void doSave() {
		...
		prescription.setOrderDate(dcDCdate.getDate());
		...
		if (Global.currentPhysisianOrdersKey == 0) {
			ls.setDateCreated(new Date());
		} else {
			ls.setDateCreated(creationDate);
		}
		ls.setLastModified(new Date());
		try {
