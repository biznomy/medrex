...
public class PaneOrderTreatmentTemp extends JxPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7734694204995337475L;
	private medrex.client.main.physicanOrders.physicianOrderScreen.PhysicianOrdersDiagnosisTemoJTable physicianOrdersDiagnosisJTable;
	private JxTable tableDiagnosis;

	public PaneOrderTreatmentTemp() {
		...
		tableDiagnosis = new JxTable() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2036788508355960231L;
		...
		physicianOrdersDiagnosisJTable = new PhysicianOrdersDiagnosisTemoJTable();
		...
		panel_2.add(new PanelPhysicianOrderTreatmentTemp());
...
class PhysicianOrdersDiagnosisTemoJTable extends AbstractTableModel {
	...
	PhysicianOrdersDiagnosisTemoJTable(List records) {
		l = records;
	}

	PhysicianOrdersDiagnosisTemoJTable() {
		l = new ArrayList();
	}
