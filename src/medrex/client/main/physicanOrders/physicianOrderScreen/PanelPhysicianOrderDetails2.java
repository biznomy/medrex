...
public class PanelPhysicianOrderDetails2 extends JxPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 977389713041194530L;
	...
	private PhysicianOrderDietJTable2 dietTable;

	public PanelPhysicianOrderDetails2() {
		super();
		setArc(0f);
		...
		panel_5 = new JxPanel() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -3504222836837188713L;
			/*
		...
		dietTable = new PhysicianOrderDietJTable2();
		...
		panelCenter.add(panel_9, BorderLayout.EAST);
		...
		panel_9.add(scrollPane, BorderLayout.EAST);
		scrollPane.setBounds(8, 52, 680, 186);
	...
	public void updatePhysicianOrderJTable() {
		...
		// try {
		//				
		// physRecords = (List<PhysicianOrderRecord>)
		// MedrexClientManager.getInstance().getPhysicianOrderRecords(Global.currentPhysicianOrderFormType,Global.currentResidenceKey);
		//				
		// } catch (Exception e) {
		// e.printStackTrace();
		// }
	...
	public static void main(String ar[]) {
		SwingUtils.wrapInDialog(new PanelPhysicianOrderDetails2()).setVisible(
				true);
	}
}

class PhysicianOrderDietJTable2 extends AbstractTableModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7143532849532499863L;
	...
	PhysicianOrderDietJTable2(List<PhysicianOrderRecord> physRecords) {
		physicianOrderRecords = physRecords;

	}

	PhysicianOrderDietJTable2() {
