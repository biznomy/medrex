...
public class PanelCautionPopUp extends PopUpView {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5140260537956263742L;
	 ...
	 */
	public PanelCautionPopUp(String medicationType) {
		super();
		setSize(400, 342);
		...
		acceptButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				if ("RM"
						.equalsIgnoreCase(PanelCautionPopUp.this.medicationType)) {
		 ...
		 * declineButton.addActionListener(new ActionListener() { public void
		 * actionPerformed(final ActionEvent e) { //2 stands for decline
		 * setStatus(2); Global.frameMedicationDashboard.setCurrentIndex(6);
		 * Global.frameMedicationDashboard.reDrawTheFrame(); close(); } });
		 * declineButton.setFont(new Font("Tahoma", Font.BOLD, 12));
		 * declineButton.setForeground(ColorConstants.DEF_COLOR);
		 * declineButton.setBackground(Color.WHITE); declineButton.setArc(0.4f);
		 * declineButton.setText("Decline"); declineButton.setBounds(149, 212,
		 * 102, 26); panel_1.add(declineButton);
		 */

		/*
		 * final JxButton okButton = new JxButton();
		 * okButton.addActionListener(new ActionListener() { public void
		 * actionPerformed(final ActionEvent e) { close();
		 * Global.frameMedicationDashboard.setCurrentIndex(3);
		 * Global.frameMedicationDashboard.reDrawTheFrame(); } });
		 * okButton.setForeground(ColorConstants.DEF_COLOR);
		 * okButton.setFont(new Font("Tahoma", Font.BOLD, 12));
		 * okButton.setBackground(Color.WHITE); okButton.setArc(0.4f);
		 * okButton.setText("OK"); okButton.setBounds(273, 212, 94, 26);
		...
		// Global.frameMedicationDashboard.getCurrentMedication().getMedication()+"";
		String cautionName = "";
		try {
		...
		thisMedicationShouldLabel.setWrapStyleWord(true);
