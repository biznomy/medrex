...
public class PanelMedicationDecline extends PopUpView {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5779048026365391022L;

	public PanelMedicationDecline() {
		super();
	...
	public static void main(String ar[]) {
		SwingUtils.wrapInDialog(new PanelMedicationDecline()).setVisible(true);
	}
