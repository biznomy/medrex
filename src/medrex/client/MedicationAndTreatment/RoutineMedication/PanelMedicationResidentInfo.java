...
import medrex.client.MedicationAndTreatment.RoutineMedication.MedicationScheduler.PanelMedicationScheduler;
...
public class PanelMedicationResidentInfo extends JxPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7453278541194605020L;
	...
	private JComponent medicationPanel;
	...
	public PanelMedicationResidentInfo(
		...
		borderLayout_1.setVgap(50);
		centerPanel.setLayout(borderLayout_1);
		...
		panelTemp.setLayout(flowLayout_5);
		panelTemp.setAutoscrolls(false);
		...
		panelMedicationScheduler.setOpaque(false);
		panelMedicationScheduler.setPreferredSize(new Dimension(
				(int) (width / 1.4), (int) (height / 1.8)));
		panelTemp.add(panelMedicationScheduler);

		centerPanel.add(panelTemp);
		...
		panel_6.setPreferredSize(new Dimension((int) (width / 3.2),
				(int) (height / 1.5)));
		// panel_6.setPreferredSize(new Dimension((int)280, (int) 280));
		...
		painAssessmentButton.setHorizontalTextPosition(SwingConstants.CENTER);
		painAssessmentButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				PanelMedicationPainAssessment painAssessment = new PanelMedicationPainAssessment();
				SwingUtils.openInDialog(painAssessment, null);
				painAssessmentButton.setText("PAIN ASSESSMENT ( "
						+ painAssessment.getScore() + " )");
			}
		});
		...
		painAssessmentButton.setPreferredSize(new Dimension(180, 50));
		...
		medicationPanel.setPreferredSize(new Dimension(400, 280));
		...
		panel_12.setBounds(293, 5, 82, 19);
		...
		panel_12_1.setBounds(215, 5, 72, 19);
		medicationPanel.add(panel_12_1);
		...
		panel_12_1.add(routeLabel);

		doLoad();
		showMedicationPanel();

		final JPanel panelWestBlank = new JPanel();
		panelWestBlank.setOpaque(false);
		add(panelWestBlank, BorderLayout.WEST);
	}
	...
	public void doLoad() {
		...
		try {
			...
			if (!"".equalsIgnoreCase(tempAllergies)) {
				...
				txtAllergies.setCaretPosition(0);
			}

			// diagnosis =
			// MedrexClientManager.getInstance().getResidentDiagnosiss(resId);
	...
	public void showMedicationPanel() {
		...
		while (it.hasNext()) {
			...
			RunTimepanel[panelNo].setBounds(10, 25 + (panelNo * 76), 380, 76);
		...
		medicationPanel.setPreferredSize(new Dimension(265, (int) height));
	}
