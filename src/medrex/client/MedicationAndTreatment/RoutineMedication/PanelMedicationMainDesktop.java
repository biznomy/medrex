...
public class PanelMedicationMainDesktop extends JPanel {
	...
	public PanelMedicationMainDesktop(
		...
		chooseResidentLabel.setText("Medication Cart (RM)");
		...
		currentList.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(final PropertyChangeEvent evt) {
				if (evt.getPropertyName().equalsIgnoreCase(
					...
					PanelMedicationMainDesktop.this.parent.setCurrentIndex(3);
					PanelMedicationMainDesktop.this.parent.reDrawTheFrame();
				}
			}
		});
		...
		rbSortTime.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				doSort("SORT_TIME", PanelMedicationMainDesktop.this.elements);
			}
		});
		...
		rbSortRoom.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				doSort("SORT_ROOM", PanelMedicationMainDesktop.this.elements);
			}
		});
		...
		rbSortLastName.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				doSort("SORT_LAST_NAME",
						PanelMedicationMainDesktop.this.elements);
			}
		});
