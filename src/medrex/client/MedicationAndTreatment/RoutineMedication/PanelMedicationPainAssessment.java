...
public class PanelMedicationPainAssessment extends PopUpView {

	/**
	 * 
	 */
	private static final long serialVersionUID = -934365343525729692L;
	...
	public PanelMedicationPainAssessment() {
		super();
		...
		btnEnter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent arg0) {
				setScore(PanelMedicationPainAssessment.this.score);
				close();
			}
		});
		...
		if ("NUMERICAL".equalsIgnoreCase(scaleType)) {
			...
			slider.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent e) {
					PanelMedicationPainAssessment.this.lblPainAssessment
	...
	public static void main(String[] args) {
		SwingUtils.wrapInDialog(new PanelMedicationPainAssessment())
				.setVisible(true);
