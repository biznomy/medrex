...
public class PanelResidentInfoPopUp extends PopUpView {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3501425490646438676L;
	...
	public PanelResidentInfoPopUp(String name, List listOfObject) {
		super();
		this.name = name;
