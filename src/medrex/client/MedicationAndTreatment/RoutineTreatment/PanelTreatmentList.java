...
public class PanelTreatmentList extends PopUpView {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6307886054775882577L;
	...
	private void fillCombos() {
		...
		try {
			medicationList = MedrexClientManager.getInstance().getMedication();
		} catch (Exception e) {
			// e.printStackTrace();
		}
		Iterator<Medication> itr = medicationList.iterator();
	...
	public static void main(String args[]) {
		PanelTreatmentList li = new PanelTreatmentList();
		li.setSize(650, 105);
