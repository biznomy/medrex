...
public class PanelTreatmentPRNReason extends PopUpView {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8597309033298508088L;
	private MedicationView medication = null;
	private JTextArea txtReason;

	public PanelTreatmentPRNReason(MedicationView currentMedication) {
		super();
