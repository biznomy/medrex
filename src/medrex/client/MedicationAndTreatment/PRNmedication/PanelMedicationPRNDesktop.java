...
public class PanelMedicationPRNDesktop extends JPanel {
	...
	public PanelMedicationPRNDesktop(
		...
		currentList.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(final PropertyChangeEvent evt) {
				if (evt.getPropertyName().equalsIgnoreCase(
					...
					PanelMedicationPRNDesktop.this.parent.setCurrentIndex(6);
					PanelMedicationPRNDesktop.this.parent.reDrawTheFrame();
				}
			}
		});
		...
		rbSortRoom.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				doSort("SORT_ROOM", PanelMedicationPRNDesktop.this.elements);
			}
		});
		...
		rbSortLastName.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				doSort("SORT_LAST_NAME",
						PanelMedicationPRNDesktop.this.elements);
			}
		});
