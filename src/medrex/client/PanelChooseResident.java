...
public class PanelChooseResident extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7178284778132354596L;
	...
	public static void main(String args[]) {
		...
		// MedrexClientManager.setArgs(args);
		// MedrexClientManager.getInstance().connect();
		// try {
		// MedrexClientManager.getInstance().getMasterListRecord(MasterList.class,
		// 1);
		// } catch (Exception e) {
		// // TODO Auto-generated catch block
		// e.printStackTrace();
		// }
		// new FrameMainOptions().setVisible(true);
		// JFrame frm = new JFrame("Panel Resident");
		// JPanel panel= new PanelChooseResident();
		// panel.setPreferredSize(new Dimension(400,500));
		// frm.getContentPane().add(panel);
		// frm.setSize(new Dimension(400,600));
		// frm.setVisible(true);
		// frm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		// SwingUtils.wrapInFrame(new PanelChooseResident()).setVisible(true);
		// // PanelChooseResident panelChooseResident
		// panelChooseResident.setVisible(true);
	}
