...
public class PanelMedicalOrdersLSTPage2 extends JxPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 982120359812612314L;
	...
	private JxLabel jxLabel_18_1;
	private JxLabel jxLabel_18;
	...
	public PanelMedicalOrdersLSTPage2() {
		...
		jxLabel_18 = new JxLabel();
		jxLabel_18.setTheme(theme);
		jxLabel_18.setText("");
		jxLabel_18.setBounds(2, 30, 100, 11);
		jxPanel_1.add(jxLabel_18);

		jxLabel_18_1 = new JxLabel();
		jxLabel_18_1.setTheme(theme);
		jxLabel_18_1.setText("");
		jxLabel_18_1.setBounds(150, 30, 100, 11);
		jxPanel_1.add(jxLabel_18_1);
		...
		datetimeJxLabel_1.setText("DATE/TIME");
		datetimeJxLabel_1.setBounds(500, 54, 60, 14);
		jxPanel_1.add(datetimeJxLabel_1);

		jxLabel_8 = new JxLabel();
		jxLabel_8.setTheme(theme);
		jxLabel_8.setText("");
		jxLabel_8.setBounds(500, 28, 60, 14);
		...
		lblResuscitationInstructions.setBounds(0, 5, 830, 17);
